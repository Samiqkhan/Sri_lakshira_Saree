    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        const formattedProduct: Product = {
          ...
          images: [data.image, ...(data.images || [])].filter(Boolean), 
          description: data.description || 'Experience the elegance of traditional craftsmanship with this exquisite saree.',
          fabric: data.fabric,
